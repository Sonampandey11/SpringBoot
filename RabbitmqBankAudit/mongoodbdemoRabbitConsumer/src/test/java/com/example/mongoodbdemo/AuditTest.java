...
public class AuditTest {
	...
	public void viewDetailsByIdTest() throws AuditException
	{
		...
		Mockito.when(auditRepository.findByEventId(Mockito.any(UUID.class))).thenReturn(obj);
...
*/
	...
	public void deleteAuditTest() throws AuditException
	{
		...
		UUID uid = UUID.fromString("38400000-8cf0-11bd-b23e-10b96e4ef00d");
		Optional<Audit> obj=Optional.of(audit);
		when(auditRepository.findByEventId(uid)).thenReturn(obj);
...
*/
	...
	public void testUpdate() throws AuditException
	{
		...
		UUID uid = UUID.fromString("38400000-8cf0-11bd-b23e-10b96e4ef00d");
		when(auditRepository.findByEventId(uid)).thenReturn(audit);
